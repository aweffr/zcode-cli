...
export async function validatePackageTree(base = root): Promise<void> {
  ...
  if (packageJson.homepage !== "https://github.com/aweffr/zcode-cli#readme"
    || packageJson.bugs?.url !== "https://github.com/aweffr/zcode-cli/issues"
    || packageJson.repository?.type !== "git"
    || packageJson.repository?.url !== "git+https://github.com/aweffr/zcode-cli.git") {
