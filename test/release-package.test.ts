...
describe("release package", () => {
  ...
  test("defines one locked build, pack, and offline prepack path", async () => {
    ...
    expect(packageJson.homepage).toBe("https://github.com/aweffr/zcode-cli#readme");
    expect(packageJson.bugs.url).toBe("https://github.com/aweffr/zcode-cli/issues");
    expect(packageJson.repository).toEqual({
      type: "git",
      url: "git+https://github.com/aweffr/zcode-cli.git"
    });
  ...
  test("rejects a compiled TUI that was not injected into vendor", async () => {
    ...
    const packageJson = {
      ...
      homepage: "https://github.com/aweffr/zcode-cli#readme",
      bugs: { url: "https://github.com/aweffr/zcode-cli/issues" },
      license: "MIT",
